...
def glass_blur(x, severity=1):
    ...
    c = [(1, 1, 2),(1.2, 3, 4),(1.5, 4, 5),(2, 6, 7),(3, 7, 8)][
        severity - 1]
...
def defocus_blur(x, severity=1):
    c = [(3, 0.1), (6, 0.5), (10, 0.5), (20, 0.5), (50, 0.5)][severity - 1]
...
def motion_blur(x, severity=1):
    ...
    c = [(20, 5), (30, 15), (40, 25), (50, 45), (70, 90)][severity - 1]
    x = np.array(x)
...
def zoom_blur(x, severity=1):
    c = [np.arange(1, 1.20, 0.01),
        np.arange(1, 1.30, 0.01),
        np.arange(1, 1.40, 0.02),
        np.arange(1, 1.60, 0.02),
        np.arange(1, 2, 0.03)][severity - 1]
...
def pixelate(x, severity=1):
    c = [0.6, 0.3, 0.1, 0.06, 0.03][severity - 1]
...
def elastic_transform(image, severity=1):
    ...
    alpha = [250 * 0.1, 250 * 0.15, 250 * 0.3, 250 * 0.5, 250 * 0.75][
        severity - 1]
